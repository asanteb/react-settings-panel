  ...
  (0, _createClass3.default)(Settings, [{
    ...
    value: function render() {
      ...
      var groupLayout = _react2.default.createElement(
        ...
        Groups.map(function (Group, i) {
          return _react2.default.createElement(
            ...
            { key: (0, _md2.default)('group-col-' + i), xs: true },
            Group
          );
        })
      );
      ...
      if (groupsInRows) {
        groupLayout = _react2.default.createElement(
          ...
          Groups.map(function (Group, i) {
            return _react2.default.createElement(
              _reactFlexboxGrid.Row,
              { key: (0, _md2.default)('group-row-' + i), style: { margin: '8px' } },
              Group
            );
          })
        );
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'settings-layout ' + width, style: this.state.styles },
          Toolbar,
          _react2.default.createElement(
...
Settings.propTypes = {
  ...
  noButtons: _propTypes2.default.bool,
  width: _propTypes2.default.string,
  groupsInRows: _propTypes2.default.bool
};
