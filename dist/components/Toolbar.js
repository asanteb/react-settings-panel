...
var Toolbar = (_dec = (0, _mobxReact.inject)('store'), _dec(_class = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_Component) {
	...
	return Toolbar;
}(_react.Component), _class2.displayName = "TOOLBAR", _temp)) || _class) || _class);
